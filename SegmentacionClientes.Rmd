---
title: "TAE - Trabajo 2 - Segmentacion de clientes"
author: '----'
date: "23/4/2021"
...
**Objetivo**: Segmentar de manera optima los clientes segun sus caracteristicas y preferencias de consumo.
...
bdclientes <- read_delim("base_trabajo_segmentacion.csv", ';')
```
